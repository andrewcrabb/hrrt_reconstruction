...
// extern  int m_nsegs, *m_segz0, *m_segzmax, *m_segzoffset, *m_segzoffset_span9, conversiontable[];
extern  int m_nsegs;
extern std::vector<int> conversiontable;
extern std::vector<int> m_segz0;
extern std::vector<int> m_segzmax;
extern std::vector<int> m_segzoffset_span9;
extern std::vector<int> m_segzoffset;
