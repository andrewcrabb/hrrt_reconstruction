...
static float parse_float(const char *str, AIR_Error *errcode)
			...
			switch(*current_char++){
				...
				case 'x':
					...
					if(current_arg<end_of_args){
						...
						AIR_Error errcode;
						/* Use static definition of parse_float to avoid printed error */
						x_shift=parse_float(*current_arg, &errcode);
				...
				case 'y':
					...
					if(current_arg<end_of_args){
						AIR_Error errcode;
						/* Use static definition of parse_float to avoid printed error */
						y_shift=parse_float(*current_arg, &errcode);
				...
				case 'z':
					...
					if(current_arg<end_of_args){
						AIR_Error errcode;
						/* Use static definition of parse_float to avoid printed error */
						z_shift=parse_float(*current_arg, &errcode);
