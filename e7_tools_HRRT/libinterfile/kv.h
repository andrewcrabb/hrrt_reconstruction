...
private:
  ...
  typedef struct {
    union {                    /*! unsigned short int value */
  ...
  /*! value of key */
  typedef union {
    std::string *ascii;               /*!< pointer to string */
    std::vector <unsigned short int> *usi_l;  /*! vector of unsigned short ints */
    std::vector <unsigned long int> *uli_l;  /*! vector of unsigned long ints */
    std::vector <float> *f_l;          /*!< vector of floats */
    std::vector <std::string> *ascii_l;  /*! vector of strings */
    std::vector <tarray *> *array;  /*! vector of array elements */
