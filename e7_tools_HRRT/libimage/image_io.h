...
class ImageIO
 { public:
    ...
    typedef enum { SCATTER_NoScatter,             /*!< no scatter correction */
                                     /*! scatter correction by deconvolution */
                   SCATTER_ScatterDeconvolution,
                                  /*! scatter correction based on simulation */
                   SCATTER_ScatterSimulated,
                           /*! scatter correction by dual energy measurement */
                   SCATTER_ScatterDualEnergy
                 } tscatter;
