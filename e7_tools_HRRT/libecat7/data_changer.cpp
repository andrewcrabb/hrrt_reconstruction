 ...
 */
/*---------------------------------------------------------------------------*/
DataChanger::DataChanger(const unsigned long int ibuffer_size,
                         const bool ivax_format,
                         const bool big_endian_format)
 ...
 */
/*---------------------------------------------------------------------------*/
void DataChanger::Value(const unsigned short int len,
