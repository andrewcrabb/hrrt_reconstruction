...
// TODO all this needs to go in a namespace and scoped enums.
...
// TODO this should be E7::Applied_processing enum

const int E7_APPLIED_PROC_Normalized                       =    1;  // normalized
const int E7_APPLIED_PROC_Measured_Attenuation_Correction  =    2;  // measured attenuation correction
const int E7_APPLIED_PROC_Calculated_Attenuation_Correction =    4; // calculated attenuation correction
const int E7_APPLIED_PROC_X_smoothing                      =    8;  // smoothing in x-direction
const int E7_APPLIED_PROC_Y_smoothing                      =   16;         // randoms smoothing
const int E7_APPLIED_PROC_Z_smoothing                      =   32;                 // segment 0
const int E7_APPLIED_PROC_2D_scatter_correction            =   64;    // single-slice rebinning
const int E7_APPLIED_PROC_3D_scatter_correction            =  128;         // fourier rebinning
const int E7_APPLIED_PROC_Arc_correction                   =  256;        // online compression
const int E7_APPLIED_PROC_Decay_correction                 =  512;          // decay correction
const int E7_APPLIED_PROC_Online_compression               = 1024;            // arc correction
const int E7_APPLIED_PROC_FORE                             = 2048;      // 3D scatter correction
const int E7_APPLIED_PROC_SSRB                             = 4096;      // 2D scatter correction
const int E7_APPLIED_PROC_SEG0                             = 8192;   // smoothing in z-direction
const int E7_APPLIED_PROC_Randoms_Smoothing                = 16384;  // smoothing in y-direction
...
const int E7_COIN_SAMP_MODE_PromptsDelayed         = 1;         // trues with TOF information
const int E7_COIN_SAMP_MODE_PromptsDelayedMultiples = 2;   // prompts, delayed and multiples
const int E7_COIN_SAMP_MODE_TruesTOF               = 3;                // prompts and delayed
...
const int E7_ACQUISITION_TYPE_Transmission           = 2; // emission scan (rectilinear)
const int E7_ACQUISITION_TYPE_StaticEmission         = 3;  // transmission scan (rectilinear)
const int E7_ACQUISITION_TYPE_DynamicEmission        = 4;    // gated emission scan
const int E7_ACQUISITION_TYPE_GatedEmission          = 5;   // dynamic emission scan
const int E7_ACQUISITION_TYPE_TransmissionRectilinear = 6;   // static emission scan
const int E7_ACQUISITION_TYPE_EmissionRectilinear    = 7;       // transmission scan
// acquisition mode
const int E7_ACQUISITION_MODE_Normal              = 0; // normal acquisition
const int E7_ACQUISITION_MODE_Windowed            = 1;  // simultaneous emission and transmission
const int E7_ACQUISITION_MODE_WindowedNonwindowed = 2;  // upper energy window acquisition
const int E7_ACQUISITION_MODE_DualEnergy          = 3;     // dual energy acquisition
const int E7_ACQUISITION_MODE_UpperEnergy         = 4;  // windowed and non-windowed acquisition
const int E7_ACQUISITION_MODE_EmissionTransmission = 5;    // windowed acquisition
...
// patient orientation
const int E7_PATIENT_ORIENTATION_Feet_First_Prone          = 0;      // unknown orientation
const int E7_PATIENT_ORIENTATION_Head_First_Prone          = 1;  // head first decubitus left
const int E7_PATIENT_ORIENTATION_Feet_First_Supine         = 2;   // feet first decubitus left
const int E7_PATIENT_ORIENTATION_Head_First_Supine         = 3;  // head first decubitus right
const int E7_PATIENT_ORIENTATION_Feet_First_Decubitus_Right = 4; // feet first decubitus right
const int E7_PATIENT_ORIENTATION_Head_First_Decubitus_Right = 5;  // head first supine
const int E7_PATIENT_ORIENTATION_Feet_First_Decubitus_Left = 6;   // feet first supine
const int E7_PATIENT_ORIENTATION_Head_First_Decubitus_Left = 7;    // head first prone
const int E7_PATIENT_ORIENTATION_Unknown_Orientation       = 8;     // feet first prone
