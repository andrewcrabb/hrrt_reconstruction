...
class ECAT7
 { private:
    std::string in_filename,                       /*!< filename for loading */
                out_filename;                      /*!< filename for storing */
    ECAT7_MAINHEADER *e7_main_header;         /*!< main header of ECAT7 file */
    ECAT7_DIRECTORY *e7_directory;              /*!< directory of ECAT7 file */
                                       /*! array of matrices from ECAT7 file */
    std::vector <ECAT7_MATRIX *> e7_matrix;
   ...
   public:
    ...
    void CreateNormMatrices(const unsigned short int);  // create Norm matrices
                                                      // create Norm3D matrices
    void CreateNorm3DMatrices(const unsigned short int);
                                                   // create Polar map matrices
    void CreatePolarMatrices(const unsigned short int);
    void CreateScanMatrices(const unsigned short int);  // create Scan matrices
                                                      // create Scan3D matrices
    void CreateScan3DMatrices(const unsigned short int);
                                    // remove data from object without deleting
    void DataDeleted(const unsigned short int) const;
                                              // request data type of data part
    unsigned short int DataType(const unsigned short int) const;
                                  // delete data part of matrix and free memory
    void DeleteData(const unsigned short int) const;
    ...
    ECAT7_MAINHEADER *MainHeader() const;
    ...
    void UpdateMainHeader(const std::string);
                                              // update subheader in ECAT7 file
    void UpdateSubheader(const std::string, const unsigned short int);
                                         // change values in Attenuation header
    void Attn_data_type(const signed short int,
                        const unsigned short int) const;
    void Attn_num_dimensions(const signed short int,
                             const unsigned short int) const;
    void Attn_attenuation_type(const signed short int,
                               const unsigned short int) const;
    void Attn_num_r_elements(const unsigned short int,
                             const unsigned short int) const;
    void Attn_num_angles(const unsigned short int,
                         const unsigned short int) const;
    void Attn_num_z_elements(const unsigned short int,
                             const unsigned short int) const;
    void Attn_ring_difference(const signed short int,
                              const unsigned short int) const;
    ...
    void Attn_num_additional_atten_coeff(const signed short int,
                                         const unsigned short int) const;
    void Attn_additional_atten_coeff(const float, const unsigned short int,
                                     const unsigned short int) const;
    void Attn_edge_finding_threshold(const float,
                                     const unsigned short int) const;
    void Attn_storage_order(const signed short int,
                            const unsigned short int) const;
    void Attn_span(const signed short int, const unsigned short int) const;
    void Attn_z_elements(const signed short int, const unsigned short int,
                         unsigned short int) const;
    void Attn_fill_unused(const signed short int, const unsigned short int,
                          unsigned short int) const;
    void Attn_fill_user(const signed short int, const unsigned short int,
                        unsigned short int) const;
                                      // request values from Attenuation header
    signed short int Attn_data_type(const unsigned short int) const;
    ...
    signed short int Attn_num_additional_atten_coeff(
                                               const unsigned short int) const;
    float Attn_additional_atten_coeff(const unsigned short int,
                                      const unsigned short int) const;
    ...
    signed short int Attn_z_elements(const unsigned short int,
                                     const unsigned short int) const;
    signed short int Attn_fill_unused(const unsigned short int,
                                      const unsigned short int) const;
    signed short int Attn_fill_user(const unsigned short int,
                                    const unsigned short int) const;
                                                  // change values in directory
    void Dir_bed(const signed long int, const unsigned short int) const;
    ...
    void Dir_data(const signed long int, const unsigned short int) const;
                                               // request values from directory
    signed long int Dir_bed(const unsigned short int) const;
    ...
    signed long int Dir_data(const unsigned short int) const;
                                               // change values in Image header
    void Image_data_type(const signed short int,
                         const unsigned short int) const;
    ...
    void Image_image_min(const signed short int,
                         const unsigned short int) const;
    void Image_image_max(const signed short int,
                         const unsigned short int) const;
    ...
    void Image_frame_duration(const signed long int,
                              const unsigned short int) const;
    void Image_frame_start_time(const signed long int,
                                const unsigned short int) const;
    void Image_filter_code(const signed short int,
                           const unsigned short int) const;
    ...
    void Image_processing_code(const signed long int,
                               const unsigned short int) const;
    void Image_gate_duration(const signed long int,
                             const unsigned short int) const;
    void Image_r_wave_offset(const signed long int,
                             const unsigned short int) const;
    void Image_num_accepted_beats(const signed long int,
                                  const unsigned short int) const;
    void Image_filter_cutoff_frequency(const float,
                                       const unsigned short int) const;
    ...
    void Image_filter_order(const signed short int,
                            const unsigned short int) const;
    void Image_filter_scatter_fraction(const float,
                                       const unsigned short int) const;
    void Image_filter_scatter_slope(const float,
                                    const unsigned short int) const;
    void Image_annotation(unsigned char * const,
                          const unsigned short int) const;
    ...
    void Image_rfilter_code(const signed short int,
                            const unsigned short int) const;
    void Image_rfilter_order(const signed short int,
                             const unsigned short int) const;
    ...
    void Image_zfilter_code(const signed short int,
                            const unsigned short int) const;
    void Image_zfilter_order(const signed short int,
                             const unsigned short int) const;
    ...
    void Image_scatter_type(const signed short int,
                            const unsigned short int) const;
    void Image_recon_type(const signed short int,
                          const unsigned short int) const;
    void Image_recon_views(const signed short int,
                           const unsigned short int) const;
    void Image_fill_cti(const signed short int, const unsigned short int,
                        const unsigned short int) const;
    void Image_fill_user(const signed short int, const unsigned short int,
                         const unsigned short int) const;
    ...
    signed short int Image_fill_cti(const unsigned short int,
                                    const unsigned short int) const;
    signed short int Image_fill_user(const unsigned short int,
                                     const unsigned short int) const;
                                                // change values in main header
    void Main_magic_number(unsigned char * const) const;
    ...
    unsigned char *Main_magic_number() const;
    ...
    signed short int Main_fill_cti(const unsigned short int) const;
                                                // change values in Norm header
    void Norm_data_type(const signed short int,
                        const unsigned short int) const;
    void Norm_num_dimensions(const signed short int,
                             const unsigned short int) const;
    void Norm_num_r_elements(const signed short int,
                             const unsigned short int) const;
    void Norm_num_angles(const signed short int,
                         const unsigned short int) const;
    void Norm_num_z_elements(const signed short int,
                             const unsigned short int) const;
    void Norm_crystals_per_ring(const signed short int,
                                const unsigned short int) const;
    void Norm_ring_difference(const signed short int,
                              const unsigned short int) const;
    ...
    void Norm_norm_quality_factor_code(const signed short int,
                                       const unsigned short int) const;
    void Norm_storage_order(const signed short int,
                            const unsigned short int) const;
    void Norm_span(const signed short int, const unsigned short int) const;
    void Norm_z_elements(const signed short int, const unsigned short int,
                         const unsigned short int) const;
    void Norm_fill_cti(const signed short int, const unsigned short int,
                       const unsigned short int) const;
    void Norm_fill_user(const signed short int, const unsigned short int,
                        const unsigned short int) const;
                                             // request values from Norm header
    signed short int Norm_data_type(const unsigned short int) const;
    ...
    signed short int Norm_norm_quality_factor_code(
                                               const unsigned short int) const;
    ...
    signed short int Norm_z_elements(const unsigned short int,
                                     const unsigned short int) const;
    signed short int Norm_fill_cti(const unsigned short int,
                                   const unsigned short int) const;
    signed short int Norm_fill_user(const unsigned short int,
                                    const unsigned short int) const;
                                              // change values in Norm3D header
    void Norm3D_data_type(const signed short int,
                          const unsigned short int) const;
    void Norm3D_num_r_elements(const signed short int,
                               const unsigned short int) const;
    void Norm3D_num_transaxial_crystals(const signed short int,
                                        const unsigned short int) const;
    void Norm3D_num_crystal_rings(const signed short int,
                                  const unsigned short int) const;
    void Norm3D_crystals_per_ring(const signed short int,
                                  const unsigned short int) const;
    void Norm3D_num_geo_corr_planes(const signed short int,
                                    const unsigned short int) const;
    ...
    void Norm3D_scatter_energy(const signed short int,
                               const unsigned short int) const;
    void Norm3D_norm_quality_factor(const float,
                                    const unsigned short int) const;
    void Norm3D_norm_quality_factor_code(const signed short int,
                                         const unsigned short int) const;
    void Norm3D_ring_dtcor1(const float, const unsigned short int,
                            const unsigned short int) const;
    void Norm3D_ring_dtcor2(const float, const unsigned short int,
                            const unsigned short int) const;
    void Norm3D_crystal_dtcor(const float, const unsigned short int,
                              const unsigned short int) const;
    void Norm3D_span(const signed short int, const unsigned short int) const;
    void Norm3D_max_ring_diff(const signed short int,
                              const unsigned short int) const;
    void Norm3D_fill_cti(const signed short int, const unsigned short int,
                         const unsigned short int) const;
    void Norm3D_fill_user(const signed short int, const unsigned short int,
                          const unsigned short int) const;
                                           // request values from Norm3D header
    signed short int Norm3D_data_type(const unsigned short int) const;
    signed short int Norm3D_num_r_elements(const unsigned short int) const;
    signed short int Norm3D_num_transaxial_crystals(
                                               const unsigned short int) const;
    ...
    signed short int Norm3D_num_geo_corr_planes(
                                               const unsigned short int) const;
    ...
    signed short int Norm3D_norm_quality_factor_code(
                                               const unsigned short int) const;
    float Norm3D_ring_dtcor1(const unsigned short int,
                             const unsigned short int) const;
    float Norm3D_ring_dtcor2(const unsigned short int,
                             const unsigned short int) const;
    float Norm3D_crystal_dtcor(const unsigned short int,
                               const unsigned short int) const;
    ...
    signed short int Norm3D_fill_cti(const unsigned short int,
                                     const unsigned short int) const;
    signed short int Norm3D_fill_user(const unsigned short int,
                                      const unsigned short int) const;
                                           // change values in Polar map header
    void Polar_data_type(const signed short int,
                         const unsigned short int) const;
    void Polar_polar_map_type(const signed short int,
                              const unsigned short int) const;
    void Polar_num_rings(const signed short int,
                         const unsigned short int) const;
    void Polar_sectors_per_ring(const signed short int,
                                const unsigned short int,
                                const unsigned short int) const;
    void Polar_ring_position(const float, const unsigned short int,
                             const unsigned short int) const;
    void Polar_ring_angle(const signed short int, const unsigned short int,
                          const unsigned short int) const;
    void Polar_start_angle(const signed short int,
                           const unsigned short int) const;
    void Polar_long_axis_left(const signed short int, const unsigned short int,
                              const unsigned short int) const;
    void Polar_long_axis_right(const signed short int,
                               const unsigned short int,
                               const unsigned short int) const;
    void Polar_position_data(const signed short int,
                             const unsigned short int) const;
    void Polar_image_min(const signed short int,
                         const unsigned short int) const;
    void Polar_image_max(const signed short int,
                         const unsigned short int) const;
    ...
    void Polar_frame_duration(const signed long int,
                              const unsigned short int) const;
    void Polar_frame_start_time(const signed long int,
                                const unsigned short int) const;
    void Polar_processing_code(const signed short int,
                               const unsigned short int) const;
    void Polar_quant_units(const signed short int,
                           const unsigned short int) const;
    void Polar_annotation(unsigned char * const,
                          const unsigned short int) const;
    void Polar_gate_duration(const signed long int,
                             const unsigned short int) const;
    void Polar_r_wave_offset(const signed long int,
                             const unsigned short int) const;
    void Polar_num_accepted_beats(const signed long int,
                                  const unsigned short int) const;
    void Polar_polar_map_protocol(unsigned char * const,
                                  const unsigned short int) const;
    void Polar_database_name(unsigned char * const,
                             const unsigned short int) const;
    void Polar_fill_cti(const signed short int, const unsigned short int,
                        const unsigned short int) const;
    void Polar_fill_user(const signed short int, const unsigned short int,
                         const unsigned short int) const;
                                        // request values from Polar map header
    signed short int Polar_data_type(const unsigned short int) const;
    ...
    signed short int Polar_sectors_per_ring(const unsigned short int,
                                            const unsigned short int) const;
    float Polar_ring_position(const unsigned short int,
                              const unsigned short int) const;
    signed short int Polar_ring_angle(const unsigned short int,
                                      const unsigned short int) const;
    signed short int Polar_start_angle(const unsigned short int) const;
    signed short int Polar_long_axis_left(const unsigned short int,
                                          const unsigned short int) const;
    signed short int Polar_long_axis_right(const unsigned short int,
                                           const unsigned short int) const;
    ...
    signed short int Polar_fill_cti(const unsigned short int,
                                    const unsigned short int) const;
    signed short int Polar_fill_user(const unsigned short int,
                                     const unsigned short int) const;
                                                // change values in Scan header
    void Scan_data_type(const signed short int,
                        const unsigned short int) const;
    void Scan_num_dimensions(const signed short int,
                             const unsigned short int) const;
    void Scan_num_r_elements(const unsigned short int,
                             const unsigned short int) const;
    void Scan_num_angles(const unsigned short int,
                         const unsigned short int) const;
    void Scan_corrections_applied(const signed short int,
                                  const unsigned short int) const;
    void Scan_num_z_elements(const unsigned short int,
                             const unsigned short int) const;
    void Scan_ring_difference(const signed short int,
                              const unsigned short int) const;
    ...
    void Scan_fill_gate(const signed short int, const unsigned short int,
                        const unsigned short int) const;
    void Scan_gate_duration(const signed long int,
                            const unsigned short int) const;
    void Scan_r_wave_offset(const signed long int,
                            const unsigned short int) const;
    void Scan_num_accepted_beats(const signed long int,
                                 const unsigned short int) const;
    ...
    void Scan_cor_singles(const float, const unsigned short int,
                          unsigned short int) const;
    void Scan_uncor_singles(const float, const unsigned short int,
                            unsigned short int) const;
    ...
    void Scan_total_coin_rate(const signed long int,
                              const unsigned short int) const;
    void Scan_frame_start_time(const signed long int,
                               const unsigned short int) const;
    void Scan_frame_duration(const signed long int,
                             const unsigned short int) const;
    void Scan_deadtime_correction_factor(const float,
                                         const unsigned short int) const;
    void Scan_physical_planes(const signed short int, const unsigned short int,
                              const unsigned short int) const;
    void Scan_fill_cti(const signed short int, const unsigned short int,
                       const unsigned short int) const;
    void Scan_fill_user(const signed short int, const unsigned short int,
                        const unsigned short int) const;
                                             // request values from Scan header
    signed short int Scan_data_type(const unsigned short int) const;
    ...
    signed short int Scan_fill_gate(const unsigned short int,
                                    const unsigned short int) const;
    ...
    float Scan_cor_singles(const unsigned short int,
                           const unsigned short int) const;
    float Scan_uncor_singles(const unsigned short int,
                             const unsigned short int) const;
    ...
    signed short int Scan_physical_planes(const unsigned short int,
                                          const unsigned short int) const;
    signed short int Scan_fill_cti(const unsigned short int,
                                   const unsigned short int) const;
    signed short int Scan_fill_user(const unsigned short int,
                                    const unsigned short int) const;
                                              // change values in Scan3D header
    void Scan3D_data_type(const signed short int,
                          const unsigned short int) const;
    void Scan3D_num_dimensions(const signed short int,
                               const unsigned short int) const;
    void Scan3D_num_r_elements(const unsigned short int,
                               const unsigned short int) const;
    void Scan3D_num_angles(const unsigned short int,
                           const unsigned short int) const;
    void Scan3D_corrections_applied(const signed short int,
                                    const unsigned short int) const;
    void Scan3D_num_z_elements(const unsigned short int,
                               const unsigned short int,
                               const unsigned short int) const;
    void Scan3D_ring_difference(const signed short int,
                                const unsigned short int) const;
    void Scan3D_storage_order(const signed short int,
                              const unsigned short int) const;
    void Scan3D_axial_compression(const signed short int,
                                  const unsigned short int) const;
    ...
    void Scan3D_fill_gate(const signed short int, const unsigned short int,
                          const unsigned short int) const;
    void Scan3D_gate_duration(const signed long int,
                              const unsigned short int) const;
    void Scan3D_r_wave_offset(const signed long int,
                              const unsigned short int) const;
    void Scan3D_num_accepted_beats(const signed long int,
                                   const unsigned short int) const;
    void Scan3D_scale_factor(const float, const unsigned short int) const;
    void Scan3D_scan_min(const signed short int,
                         const unsigned short int) const;
    void Scan3D_scan_max(const signed short int,
                         const unsigned short int) const;
    ...
    void Scan3D_multiples(const signed long int,
                          const unsigned short int) const;
    void Scan3D_net_trues(const signed long int,
                          const unsigned short int) const;
    ...
    void Scan3D_total_coin_rate(const signed long int,
                                const unsigned short int) const;
    void Scan3D_frame_start_time(const signed long int,
                                 const unsigned short int) const;
    void Scan3D_frame_duration(const signed long int,
                               const unsigned short int) const;
    void Scan3D_deadtime_correction_factor(const float,
                                           const unsigned short int) const;
    void Scan3D_fill_cti(const signed short int, const unsigned short int,
                         const unsigned short int) const;
    void Scan3D_fill_user(const signed short int, const unsigned short int,
                          const unsigned short int) const;
    void Scan3D_uncor_singles(const float, const unsigned short int,
                              const unsigned short int) const;
                                           // request values from Scan3D header
    signed short int Scan3D_data_type(const unsigned short int) const;
    ...
    signed short int Scan3D_corrections_applied(
                                               const unsigned short int) const;
    unsigned short int Scan3D_num_z_elements(const unsigned short int,
                                             const unsigned short int) const;
    ...
    signed short int Scan3D_fill_gate(const unsigned short int,
                                      const unsigned short int) const;
    ...
    signed short int Scan3D_fill_cti(const unsigned short int,
                                     const unsigned short int) const;
    signed short int Scan3D_fill_user(const unsigned short int,
                                      const unsigned short int) const;
