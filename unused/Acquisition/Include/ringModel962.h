//==========================================================================
// File			:	RingModel962.h  (HR+ with no CT)
...
//
#ifndef MODEL962_CLASS_H
#define MODEL962_CLASS_H

#ifdef WIN32
#ifdef GM_EXPORTS
#define MODEL962_API __declspec(dllexport)
#else
#define MODEL962_API __declspec(dllimport)
#endif
#endif
...
//
// CRingModel962 derived class
//

class CRingModel962 : public CModel {
public:
	CRingModel962();
	virtual ~CRingModel962();

	// access functions
	virtual long model() const { return 962; }
	virtual char* mName();
	void calculate();
	...
	virtual double maxScanLen() const { return (_maxScanLen != BADINIKEY) ? _maxScanLen : 235.520; }
