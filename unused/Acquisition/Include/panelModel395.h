...
// S Tolbert	15 August 02	Reversed values of Trans and Axial blocks.
...
//
#ifndef MODEL395_CLASS_H
#define MODEL395_CLASS_H

#ifdef WIN32
#ifdef GM_EXPORTS
#define MODEL395_API __declspec(dllexport)
#else
#define MODEL395_API __declspec(dllimport)
#endif
#endif
...
//
// CPanelModel395 derived class
//

class  CPanelModel395 : public CModel {
public:
	CPanelModel395();
	virtual ~CPanelModel395();

	// access functions
	virtual long model() const { return 395; }
	virtual char* mName();
	...
	virtual long numberPanels() const { return (_nheads != BADINIKEY) ? _nheads : 5; }
	...
	virtual long emModPair() const { return (_emModePair != BADINIKEY) ? _emModePair : 0xBE; }
	virtual long txModPair() const { return (_txModePair != BADINIKEY) ? _txModePair : 0x1F40; }
	virtual long emtxModPair() const { return (_emtxModePair != BADINIKEY) ? _emtxModePair : 0x1FFE; }
