...
// S Tolbert	25 Nov 02		Added function maxScattzfov and ini access
//==========================================================================

// Set guards to prevent multiple header file inclusion
//
#ifndef MODELACCEL_CLASS_H
#define MODELACCEL_CLASS_H

#ifdef WIN32
#ifdef GM_EXPORTS
#define MODELACCEL_API __declspec(dllexport)
#else
#define MODELACCEL_API __declspec(dllimport)
#endif
#endif
...
class CACCELModel : public CModel {
public:
	CACCELModel();
	virtual ~CACCELModel();

	// access functions
	virtual long model() const { return 1023; }
	virtual char* mName();
	void calculate();
	...
	virtual long logAxialBlks() const { return (_logAxBlks != BADINIKEY) ? _logAxBlks : 3; }
	...
	//virtual int totSinograms() const { return readINI? _totSino : 0; } 
	...
	virtual long transTubes() const { return (_transTubes != BADINIKEY) ? _transTubes : 0; }
