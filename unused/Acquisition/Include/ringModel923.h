//==========================================================================
// File			:	RingModel923.h  (LSO EXACT with no CT)
...
//
#ifndef MODEL923_CLASS_H
#define MODEL923_CLASS_H

#ifdef WIN32
#ifdef GM_EXPORTS
#define MODEL923_API __declspec(dllexport)
#else
#define MODEL923_API __declspec(dllimport)
#endif
#endif
...
//
// CRingModel923 derived class
//

class CRingModel923 : public CModel {
public:
	CRingModel923();
	virtual ~CRingModel923();

	// access functions
	virtual long model() const { return 923; }
	virtual char* mName();
	void calculate();
