/* Copyright 1996-2002 Roger P. Woods, M.D. */
/* Modified: 7/16/02 */

/*
 * This routine will compute the real matrix exponential of
 * a real 1x1, 2x2, 3x3 or 4x4 matrix.
 * 
...
AIR_Error AIR_eexper4(const unsigned int n, double **a, const double *toproot, const double *botroot, double ***storage2, double ***storage4)

{
	...
	}
	{
		...
		/* Find the exp of a using the Schur-Frechet algorithm */
		{
			AIR_Error errcode=AIR_exput(n,er,ei,ar,ai,toproot,botroot,storage2);
