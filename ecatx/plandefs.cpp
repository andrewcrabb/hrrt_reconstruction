...
void plandefs(int rmax,int span, int amax, int *vplane)
/* rmax: Number of crystal rings. (May be virtual) */
/* amax: Maximum number of cross planes to accept
 * for all projections. (Acceptance angle) */
/* span:  Axial compression */
/* vplane:  An rmax by rmax array to receive the plane numbers */
{
