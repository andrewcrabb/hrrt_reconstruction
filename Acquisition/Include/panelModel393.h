...
// S Tolbert	24 Oct 02		Added variable to export the model number
...
//
#ifndef MODEL393_CLASS_H
#define MODEL393_CLASS_H

#ifdef WIN32
#ifdef GM_EXPORTS
#define MODEL393_API __declspec(dllexport)
#else
#define MODEL393_API __declspec(dllimport)
#endif
#endif
...
//
// CPanelModel393 derived class
//

class CPanelModel393 : public CModel {
public:
	CPanelModel393();
	virtual ~CPanelModel393();

	// access functions
	virtual long model() const { return 393; }
	virtual char* mName();
