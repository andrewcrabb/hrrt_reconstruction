//==========================================================================
// File			:	RingModel922.h  (EXACT with no CT)
...
//
#ifndef MODEL922_CLASS_H
#define MODEL922_CLASS_H

#ifdef WIN32
#ifdef GM_EXPORTS
#define MODEL922_API __declspec(dllexport)
#else
#define MODEL922_API __declspec(dllimport)
#endif
#endif
...
//
// CRingModel922 derived class
//

class CRingModel922 : public CModel {
public:
	CRingModel922();
	virtual ~CRingModel922();

	// access functions
	virtual long model() const { return 922; }
	virtual char* mName();
	void calculate();
