...
int main(int argc, char **argv)
{
  ...
  int ecat_flag=1, cubic_flag=1;
    ...
    fprintf(stderr, "        k: keep original voxelsize size instead isotropic voxelsize output default\n");
		return 1;
	}
	in_fname = argv[1];
	if (argc>2)
  ...
  if (argc > 4) 
  {
    ...
    else if (tolower(argv[4][0]) == 'k') cubic_flag = 0;
  }
